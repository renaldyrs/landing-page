            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    <label for="category_id"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-400">Kategori</label>
                ...
                <div class="mb-4">
                    <label for="image" class="block text-sm font-medium text-gray-700 dark:text-gray-400">Gambar
                        Produk</label>
